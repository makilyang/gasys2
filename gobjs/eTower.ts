module gobjs {
    export class eTower extends DyEngine.DyObject {
        ...
        public create(): void {
            ...
            let preRes = this.resPath;
            let mcTexture = RES.getRes(preRes + "_png");
            let mcData = RES.getRes(preRes+ "_json");
            var mcDataFactory = new egret.MovieClipDataFactory(mcData, mcTexture);          
            this.animator.addAnimation("idle",new egret.MovieClip(mcDataFactory.generateMovieClipData(this.entry)));
            this.animator.addAnimation("attack", new egret.MovieClip(mcDataFactory.generateMovieClipData(this.entry+"g")));
